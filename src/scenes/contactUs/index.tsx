        ...
        <motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
            ...
            <div className="mt-10 justify-between gap-8 md:flex">
                ...
                >
                    ...
                    target="_blank"
                    onSubmit={onSubmit}
                    action="https://form.submit.co/carmelo.salis85@gmail.com"
                    method="POST"
                    >
                        <input 
                ...
                >
                    <div className="md:before:content-unlocktext w-full before:absolute before:-bottom-20 before:-right-10 before:z-[-1]">
                        <img 
                            className="w-full"
